...
function dialogueChartPayload(chart: ReturnType<typeof calculateZeteticChart>) {
  return {
    ...
    points: chart.points.map(({ name, kind, longitude, sign, degree, house, rightAscension, declination, azimuth, altitude }) => ({ name, kind, longitude, sign, degree, house, rightAscension, declination, azimuth, altitude })),
  };
}
