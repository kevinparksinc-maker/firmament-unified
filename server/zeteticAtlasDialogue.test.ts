...
const chart = {
  ...
  points: [
    { name: "Sun", kind: "planet" as const, longitude: 238.044, sign: "Scorpio", degree: 28.044, house: 1, rightAscension: 15.72, declination: -19.7, azimuth: 145.4, altitude: 29.4 },
    { name: "Ascendant", kind: "angle" as const, longitude: 234.703, sign: "Scorpio", degree: 24.703, house: 1, rightAscension: 15.49, declination: -18.9, azimuth: 148.3, altitude: 31.7 },
  ],
};
...
describe("Zetetic Atlas Scholar context", () => {
  it("includes the live source, direct angles, Equal Houses, and both coordinate layers", () => {
    ...
    expect(context).toContain("Sun [planet]: tropical longitude 238.0° = Scorpio 28.0°; Equal House H1; RA 15.72h; Dec -19.7°; local compass azimuth 145.4°, altitude 29.4°");
