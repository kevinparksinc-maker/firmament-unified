...
const pregameRecord = {
  question: "Frozen historical God-axis regression only. Return the ASC/DSC polarity and God–Agent Family Flow audit; do not provide betting advice.",
  year: 2026,
  month: 6,
  day: 27,
  hour: 18,
...
const standard = await callTrpc("sportsHorary.godAgentFlow", { ...pregameRecord, mapOrientation: "standard" });
const inverse = await callTrpc("sportsHorary.godAgentFlow", { ...pregameRecord, mapOrientation: "inverse-180" });
