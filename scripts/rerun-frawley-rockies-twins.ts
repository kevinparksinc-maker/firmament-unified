...
const pregameRecord = {
  question: "Frozen historical Frawley regression only. Return the auditable event-chart evidence; do not provide betting advice.",
  year: 2026,
  month: 6,
  day: 27,
  hour: 18,
...
const standard = await callTrpc("sportsHorary.frawleyEvent", { ...pregameRecord, mapOrientation: "standard" });
const inverse = await callTrpc("sportsHorary.frawleyEvent", { ...pregameRecord, mapOrientation: "inverse-180" });
